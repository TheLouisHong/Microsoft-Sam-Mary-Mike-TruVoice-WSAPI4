# Microsoft Developer Studio Generated NMAKE File, Based on MSMouth.dsp
!IF "$(CFG)" == ""
CFG=MSMouth - Win32 Debug
!MESSAGE No configuration specified. Defaulting to MSMouth - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "MSMouth - Win32 (ALPHA) Debug" && "$(CFG)" !=\
 "MSMouth - Win32 (ALPHA) Release" && "$(CFG)" != "MSMouth - Win32 Release" &&\
 "$(CFG)" != "MSMouth - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(INTDIR)\MSMouth.res"
	-@erase "$(INTDIR)\Paint.obj"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(INTDIR)\vc50.pdb"
	-@erase "$(OUTDIR)\MSMouth.exe"
	-@erase "$(OUTDIR)\MSMouth.pdb"
...
CPP_PROJ=/nologo /MLd /Gt0 /W3 /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)\MSMouth.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\AlphaDbg/
CPP_SBRS=.
...
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\MSMouth.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MSMouth.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /nologo\
 /subsystem:windows /pdb:"$(OUTDIR)\MSMouth.pdb" /debug /machine:ALPHA\
 /out:"$(OUTDIR)\MSMouth.exe" 
LINK32_OBJS= \
	"$(INTDIR)\main.obj" \
	"$(INTDIR)\MSMouth.res" \
	"$(INTDIR)\Paint.obj"

"$(OUTDIR)\MSMouth.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\MSMouth.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MSMouth.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /nologo\
 /subsystem:windows /pdb:"$(OUTDIR)\MSMouth.pdb" /machine:ALPHA\
 /out:"$(OUTDIR)\MSMouth.exe" 
LINK32_OBJS= \
	"$(INTDIR)\main.obj" \
	"$(INTDIR)\MSMouth.res" \
...
LINK32_FLAGS=comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\MSMouth.pdb" /machine:IX86 /out:"$(OUTDIR)\MSMouth.exe" 
LINK32_OBJS= \
	"$(INTDIR)\main.obj" \
	"$(INTDIR)\MSMouth.res" \
	"$(INTDIR)\Paint.obj"
...
LINK32_FLAGS=comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\MSMouth.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\MSMouth.exe"\
 /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\main.obj" \
	"$(INTDIR)\MSMouth.res" \
...
"$(INTDIR)\MSMouth.res" : $(SOURCE) $(DEP_RSC_MSMOU) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
